  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-bg px-5 text-center text-ink">
      ...
      <div className="mt-10 w-full max-w-md rounded-[2rem] bg-violet p-8 shadow-sm">
        ...
        {/* Convite direto do Discord (2026-09-05) — ver nota em
            app/configuracoes/page.tsx: o formulário externo parou de abrir. */}
      ...
      <div className="mt-6 w-full max-w-md rounded-[2rem] border border-accent/20 bg-accent/5 p-6">
        ...
        <p className="mt-1 text-sm text-muted">Crie seu primeiro bio site profissional agora mesmo.</p>
      ...
      <p className="mt-10 text-xs text-muted">Dúvidas? Fale no Discord ou envie um e-mail para leonardomarusso1@gmail.com</p>
    </main>
  );
}
