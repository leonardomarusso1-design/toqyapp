    ...
    <LegalPageShell title="Contrato de Assinatura" updatedAt="16/07/2026">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Pro</td><td>R$9,90/mês</td><td>Recorrente mensal</td><td>1 (domínio próprio: add-on avulso)</td></tr>
      ...
      <p>
        <strong>Atenção:</strong> os planos Pro, Essencial, Freelancer e Agência são assinaturas com cobrança
        recorrente mensal — as seções 3, 5, 6 e 8 abaixo (cobrança recorrente, cancelamento de renovação,
        reajuste, inadimplência) se aplicam aos quatro.
      </p>
      <p>
      ...
      <h2>3. Cobrança recorrente (planos Pro, Essencial, Freelancer e Agência)</h2>
      <p>
        Os planos Pro, Essencial, Freelancer e Agência são cobrados de forma recorrente mensal. A cobrança é
      ...
      <p>
        ...
        (Pro, Essencial, Freelancer ou Agência), com <strong>reembolso integral</strong> do valor pago, sem
        necessidade de justificativa. Para exercer esse direito, entre em contato em
        leonardomarusso1@gmail.com dentro desse prazo.
      </p>

      <h2>5. Cancelamento (planos Pro, Essencial, Freelancer e Agência)</h2>
      <p>
        Você pode cancelar sua assinatura Pro, Essencial, Freelancer ou Agência a qualquer momento, solicitando
      ...
      <h2>6. Reajuste de preço (planos Pro, Essencial, Freelancer e Agência)</h2>
      <p>
        Podemos reajustar o valor das assinaturas Pro, Essencial, Freelancer e Agência mediante aviso prévio de
      ...
      <h2>8. Inadimplência (planos Pro, Essencial, Freelancer e Agência)</h2>
      <p>
        Em caso de falha na cobrança recorrente das assinaturas Pro, Essencial, Freelancer ou Agência, poderemos
      ...
      <h2>10. Contato</h2>
      <p>Dúvidas sobre cobrança, cancelamento ou este contrato: leonardomarusso1@gmail.com · Instagram <a href="https://www.instagram.com/toqycontact/" target="_blank" rel="noopener noreferrer">@toqycontact</a>.</p>
    </LegalPageShell>
  );
}
