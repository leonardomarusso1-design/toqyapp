      ...
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        <div className="rounded-[2rem] border border-border bg-card p-6 shadow-sm">
          ...
          {/* Discord — aberto pra qualquer plano (2026-07-16): acesso à
              comunidade virou gratuito/aberto. Apontava pro formulário/quiz
              de entrada (leonardomarusso.com.br/comunidade) como porta de
              entrada — trocado (2026-09-05, achado ao vivo pelo Leonardo)
              pro convite direto do Discord, porque o formulário externo
              parou de abrir/dava erro. Reverter pro formulário se/quando ele
              for consertado (fora deste repositório). */}
          <a href="https://discord.gg/CnxUbdgbNG" target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/70">Entre no servidor do Discord</p>
              </div>
            </div>
          ...
          {planTier === "free" && (
            <div className="mt-4 rounded-2xl border border-violet/20 bg-violet/10 p-4">
              ...
              {/* Programa de indicação com comissão (2026-07-15, comissão
                  real 2026-07-17): se esta conta foi indicada por um
                  revendedor Freelancer/Agência, o desconto (10%/15%) já vai
                  embutido no link via cupom Kiwify (?coupon=), E — se o
                  revendedor já sincronizou como afiliado — o link também
                  carrega ?afid= pra atribuir a venda a ele na Kiwify de
                  verdade (ver applyResellerAttribution em resellerTiers.ts). */}
              {couponCode ? (
