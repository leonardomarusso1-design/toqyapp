...
export default async function SlugPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const reserved = ["app", "login", "me", "editar", "onboarding", "obrigado", "b", "api", "auth", "termos", "privacidade", "cookies", "demo", "portal", "qr", "contrato-assinatura", "para-mim", "para-vender", "custom-domain", "faq"];
