...
-- pode comprar +1 avulso via Kiwify (R$5,99 bio site / R$8,99 arte — preço
-- inicial de R$2,99/R$5,99 ajustado pra cima em 2026-07-16, a Kiwify não
-- permite produto abaixo de R$5,99) sem fazer upgrade de plano inteiro.
-- Segue o MESMO padrão aditivo já usado por
...
comment on column public.profiles.overage_biosites is
  'Bio sites extras comprados avulsos (R$5,99/un via Kiwify, produto "TOQY - Bio Site Extra") — somado ao limite do plano em checkBiositeLimit() junto com referral_bonus_biosites. Nunca expira, não reseta em renovação. Só vendido pro Freelancer (Agência já tem limite generoso, 100 sites).';
...
comment on column public.profiles.overage_ai_art_credits is
  'Créditos de arte com IA extras comprados avulsos (R$8,99/un via Kiwify, produto "TOQY - Crédito de Arte Extra") — somado ao limite do plano em checkAiArtCredits() antes de comparar com ai_art_credits_used. Nunca expira/reseta, mesmo padrão vitalício de ai_art_credits_used. Vendido pro Freelancer e pra Agência.';
